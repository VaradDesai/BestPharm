...
// **********varad 
    int flag = 0;
        SalesInventoryItem ni = new SalesInventoryItem();
        if (enterprise instanceof SalesEnterprise) {
            System.out.println("in inventory SalesEnterprise");
...
//    public InventoryItem removeInventoryItemNGO(SalesInventoryItem ni){
//        
////        SalesInventoryItem ni = new SalesInventoryItem();
...
//        inventory.setNetwork(network);
     ...
     public InventoryItem addInventoryItemPharmacy (Enterprise enterprise, UserAccount ua, Medicine medicine, int qty) {
        WareHouseInventoryItem ni = new WareHouseInventoryItem();
