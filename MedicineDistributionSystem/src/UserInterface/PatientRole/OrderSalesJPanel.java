 ...
 * @author Hardik
 */
public class OrderSalesJPanel extends javax.swing.JPanel {

    /**
     * Creates new form OrderSalesJPanel
     */
    ...
    public OrderSalesJPanel(JPanel container, Enterprise enterprise, UserAccount userAccount, Network network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Order From Returned Medicines");
        ...
        orderBtn.setForeground(new java.awt.Color(255, 0, 0));
...
//            if (ent.getEnterpriseType().getValue().equals("NGO Enterprise") && ent instanceof SalesEnterprise) {
//
//                enterp = ent;
//                break;
//            }
...
// Hardik 6/12
        for (Enterprise ent : network.getEnterpriseDirectory().getEnterpriseList()) {
            if (ent.getEnterpriseType().getValue().equals("Sales") && ent instanceof SalesEnterprise) {
                for (InventoryItem inv : ent.getInventoryDirectoryEnterpriseLevel().getInventoryList()) {
