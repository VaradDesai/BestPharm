...
//        UserOrder finalOrder = new UserOrder();
        ...
        for (Enterprise enterprise : n.getEnterpriseDirectory().getEnterpriseList()) {
            if (enterprise instanceof SalesEnterprise || enterprise instanceof HospitalEnterprise) {
                System.out.println(enterprise.getName() + "---should be sales/ hospi enterprise");
...
//                Display reversed list    
    ...
    private void initComponents() {
        ...
        lblAllNetworks.setForeground(new java.awt.Color(255, 0, 0));
        lblAllNetworks.setText("Donated till date");
        ...
        networkJComboBox.setForeground(new java.awt.Color(255, 0, 0));
        ...
        lblAllNetworks2.setForeground(new java.awt.Color(255, 0, 0));
        ...
        lblAllNetworks3.setForeground(new java.awt.Color(255, 0, 0));
        ...
        lblAllNetworks4.setForeground(new java.awt.Color(255, 0, 0));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(57, 57, 57)
                                .addComponent(chart, javax.swing.GroupLayout.PREFERRED_SIZE, 245, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void chartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chartActionPerformed
        ...
        for (Network net1 : business.getNetworkList()) {
            ...
            pieDataset.setValue(net1.getName(), new Double((netTotal * 100 / ecoTotal)));
            netTotal = 0;
        }
