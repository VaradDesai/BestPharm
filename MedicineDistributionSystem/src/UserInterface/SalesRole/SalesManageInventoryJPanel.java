 ...
 * @author rishika
 */
public class SalesManageInventoryJPanel extends javax.swing.JPanel {

    /**
     * Creates new form SalesManageInventoryJPanel
     */
...
//    private SalesInventoryItem ngoInventory;
    public SalesManageInventoryJPanel(JPanel userProcessContainer, Enterprise enterprise, Network network, EcoSystem business, UserAccount account) {
        initComponents();
    ...
    private void initComponents() {
        ...
        checkExpiry.setForeground(new java.awt.Color(255, 0, 0));
...
//rishika
    ...
    private void checkExpiryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkExpiryActionPerformed
        ...
        // varad 6/12
        for (InventoryItem inv : enterprise.getInventoryDirectoryEnterpriseLevel().getInventoryList()) {
            System.out.println("in inventory inv");
            for(Medicine m : inv.getMedicineListInInventoryItem().getMedicineList())
            {
                System.out.println(m.getExpiryDate()+"in Medicine med");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        SalesInventoryItem ngoInventoryItem= (SalesInventoryItem)inventoryTable.getValueAt(selectedRow, 0);
        System.out.println(ngoInventoryItem.getMedicine()+" med is");
        
        SalesInventoryItemDetailsJPanel salesInventoryItemDetailsJPanel = new SalesInventoryItemDetailsJPanel(userProcessContainer,ngoInventoryItem);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add("salesInventoryItemDetailsJPanel", salesInventoryItemDetailsJPanel);
